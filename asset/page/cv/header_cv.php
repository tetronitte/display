<header class="header-cv bg-dark row">
    ...
    <div class="col-11-ms col-xs-7 title">
        <h1 class="h1-header-cv">Axel Noir de Chazournes</h1>
        <h2 class="h2-header-cv">Développeur</h2>
    </div>
    <div class="col-xs-4 visible-xs info-icon">
        <a href="#" class="fa fa-info" id="info-icon" title="Informations personnelles"></a>
    </div>
    <div class="modal" tabindex="-1" role="dialog" id="info-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title">Informations personnelles</span>
